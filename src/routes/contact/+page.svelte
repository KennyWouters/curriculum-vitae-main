...
<!--
  ...
  ```
-->
<div class="relative isolate bg-gray-900 animate-quickerFadeIn">
	<div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
		<div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
			<div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
				...
				<p class="mt-6 text-lg leading-8 text-gray-300">Be it with one of the options below, or with the form, contact me and I'll get back to you as fast as I can !</p>
				<dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
					<div class="flex gap-x-4">
						...
						<dd><a class="hover:text-white" href="tel:+32488818897">+32 488 81 88 97</a></dd>
					</div>
					<div class="flex gap-x-4">
						<dt class="flex-none">
						...
						<dd><a class="hover:text-white" href="mailto:kenny.wouters2@gmail.com">kenny.wouters2@gmail.com</a></dd>
					</div>
				</dl>
			</div>
		</div>
		<form action="https://formspree.io/f/xblrylqe" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
